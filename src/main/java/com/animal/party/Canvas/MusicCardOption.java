package com.animal.party.Canvas;

public class MusicCardOption {
    private String thumbnailImage;
    private String backgroundColor;
    private String backgroundImage;
    private Integer imageDarkness;
    ...
    public Integer getImageDarkness() {
        return imageDarkness;
    }

    public void setImageDarkness(Integer imageDarkness) {
        this.imageDarkness = imageDarkness;
    }
